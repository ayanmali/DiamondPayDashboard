    ...
    return (
        <div className="w-full">
            ...
            Export
                    ...
                    <Button className="flex items-center" onClick={() => setNewProductDialogOpen(true)}>
                        <PlusIcon className="mr-2 h-4 w-4" />
                        Add Product
                    </Button>
                    <AddNewCustomer open={newProductDialogOpen} onOpenChange={setNewProductDialogOpen}/>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center space-x-5 pb-4">
                {/* All */}
                    ...
                    {/* Archived */}
                    <div className={`w-48 cursor-pointer transition-all rounded-lg font-medium pl-3 text-lg bg-white ${selectedStatus === "archived" ? "border-2 border-primary" : "border"
                        }`}
