...
const chartData = [
  { month: "FirstWallet", Amount: 186, mobile: 80 },
  { month: "TradingWallet", Amount: 305, mobile: 200 },
  { month: "OtherWallet", Amount: 237, mobile: 120 },
...
export function BarChartWithLabels() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Token Balances Across Wallets</CardTitle>
