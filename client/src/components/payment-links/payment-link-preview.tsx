...
export default function PaymentLinkPreview({
  ...
  // Add this useEffect to sync cart with addedItems
  useEffect(() => {
    setCart(prevCart =>
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 w-full max-w-6xl mx-auto">
        ...
        <Card className="overflow-hidden">
          <div className="p-6 bg-white border rounded-lg shadow">
            <div className="flex flex-col h-full">
              ...
              <div className="flex">
                {/* Left Panel */}
                <div className="bg-slate-700 text-white p-6 rounded-l-lg w-full">
      ...
      {/* Form Panel */}
      <div className="w-full lg:w-1/2">
      <Button onClick={() => console.log(addedItems)}>click me</Button>
        <Card className="p-6">
          <div className="flex flex-col space-y-6">
              ...
              <>
                <div className="space-y-6">
                  <div>
                    ...
                    {/* Custom Label */}
                    <div className="mb-4">
                      <h3 className="text-gray-700 font-medium mb-2">Custom Label Here</h3>
                    ...
                    {/* Cardholder Name */}
                    <div className="mb-4">
                      <h3 className="text-gray-700 font-medium mb-2">Cardholder name</h3>
            ...
            {paymentMethod === 'applepay' && (
              <>
                <Button 
                  className="w-full bg-black hover:bg-gray-900 text-white flex items-center justify-center py-4"
                >
                  <svg className="h-6 w-6 mr-2" viewBox="0 0 24 24" fill="none">
                    <path d="M18.5 3H5.5C4.11929 3 3 4.11929 3 5.5V18.5C3 19.8807 4.11929 21 5.5 21H18.5C19.8807 21 21 19.8807 21 18.5V5.5C21 4.11929 19.8807 3 18.5 3Z" fill="currentColor"/>
                    <path d="M15.5 8.5C15.2953 8.8 14.8 9 14.5 9C14.2 9 13.7047 8.8 13.5 8.5C13.2953 8.1 13.8 7.5 14.1 7C14.4 6.5 14.7047 6.7 15 7C15.2953 7.3 15.7047 8.2 15.5 8.5Z" fill="white"/>
