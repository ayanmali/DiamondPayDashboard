...
export const SendTransaction: FC<{ paymentObject: PaymentLink | Invoice | null, isMobile: boolean }> = ({ paymentObject, isMobile }) => {
  ...
  async function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    sendTransaction({ to /*paymentObject?.wallet.address as `0x${string}`*/ , value: parseEther(value) })
  }
  ...
  return (
    <form onSubmit={submit}>
      ...
      (isMobile ? "Continue on mobile device" : "Confirming...") : "Send"}</button>
